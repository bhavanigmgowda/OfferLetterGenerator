...
export class DepuationLetter extends Component {
  ...
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}><strong>Date:&nbsp; 14th June 2019</strong></p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>To, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}><strong>Biswakalyan Sahoo,</strong></p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}><strong>&nbsp;</strong></p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>Dear <strong>Biswakalyan Sahoo</strong><strong>,</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>As a part of our services to client, please be informed that you are deputed to work at<strong>.</strong> <strong>Decurtis</strong></p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>RMZ Eco world (Coworks),&nbsp; Building 6A Bellandur.We have decided on this owing to your performance at the client interview. You accept this deputation and agree to abide by the policies and procedures of <strong>Decurtis</strong>. The date you have to report at <strong>Decurtis</strong><strong>, </strong>would be <strong>03rd June 2019</strong>.</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>&nbsp;</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>Contact Person: Sudhir</p>
  <p style={{textAlign: 'justify', paddingLeft: 30}}>Reporting Time: 10.00 AM</p>
