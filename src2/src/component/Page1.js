...
class Page1 extends Component {
   ...
   */
        ...
        this.props.history.push('/PreviewPage')
        return false;
    }
        ...
        return (
            <div>
                ...
                <div>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <ol style={{ textAlign: 'jtrueustify' }}>
                                        <li>
                                    ...
                                    <table style={{ width: 800, fontSize: '20px', marginLeft: 'auto', marginRight: 'auto' }} border="{1}">
                                        <tbody>
                                            <tr>
                                                <td style={{ width: 400, textAlign: 'justify', paddingLeft: 30, paddingRight: 10 }}>
                                                ...
                                                <td style={{ paddingLeft: 30, paddingRight: 10, width: 400, textAlign: 'justify' }}>
                                                    <p style={{ paddingTop: '30px' }}>e. PF account details</p>
                            ...
                            <div><table style={{ width: 800, marginLeft: 'auto', marginRight: 'auto', height: 250 }} border="1px">
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td style={{ width: '300px', wordBreak: 'break-all' }}>&nbsp;<strong>{this.state.employee.Name}</strong></td>
                                    </tr>
                                    <tr >
                                    ...
                                    <tr >
                                        ...
                                        <td style={{ width: '300px', wordBreak: 'break-all' }}>&nbsp;<strong>{this.state.employee.Location}</strong></td>
                                    </tr>
                                    <tr >
                    ...
                    {/*   {this.state.buttonShow ? <div>
                     
                     <a style={{ float: "right", marginRight: "340px", marginTop: "20px" }} class="btn btn-primary" onClick={()=>this.convertpdf()}>Generate Pdf</a>
                 </div>:null}
                */}


                </div>
                {this.props.buttonShow ? <div>


                    <a style={{ float: "right", marginRight: "26%", marginTop: "20px", fontWeight: "800", marginBottom: "46px", color: "whitesmoke" }} class="btn btn-info" onClick={() => this.convertpdf()}>Print Preview</a>
                </div> : null}
