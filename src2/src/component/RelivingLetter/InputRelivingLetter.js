                                    ...
                                    <div className="card-body ">
                                        <form onSubmit={this.pass}>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <MDBInput autocomplete="off" required type="date" label="Relieving Date" title="relievingDate" name="relievingDate" id="relievingDate" onChange={(event) => {
                                                        this.setState({
...
export default InputRelivingLetter