                                ...
                                <div style={{ width: '500px' }} className="card m-auto shadow-lg mt-5">
                                    ...
                                    <div className="card-body ">
                                        <form onSubmit={this.pass}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                <MDBInput autocomplete="off" required label="New Designation" type="text" name="newDesignation" id="newDesignation" title="New Designation" onChange={(event) => {
                                                        this.setState({
...
export default InputDesignationLetter