                ...
                <div className="card" id="pageA4">
                    <div className="card-body">
                        <div>
                            ...
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>I am <strong>Gnanesh J </strong>working in Test Yantra Software Solutions Pvt Ltd or Qspiders or Jspiders (u/o) Test Yantra Software Solutions Pvt Ltd as <strong>Senior QA Engineer</strong> from <strong>20<sup>th</sup> August 2018.</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>I am willing to undergo training in<strong> Appium</strong>. I would request you to permit me to take the course at Qspiders / JSpiders. Below is the details of Course and period of Training.</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>Course Name</strong>: <strong>Appium</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>Training Start Date</strong>: 15<sup>th</sup> December 2018</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>Training End Date: </strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>SPOC</strong></p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>Location:</strong> Qspiders, Basavanagudi</p>
                            <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
