    ...
    componentDidMount() {
        ...
        $(document).ready(function () {
            $('#genrate').click(function (e) {
                ...
                let trainingStartDate= document.getElementById("trainingStartDate").value;
                let trainingEndDate= document.getElementById("trainingEndDate").value;
                ...
                if (trainingEndDate === "") {
                    that.setState({ showTrainingEndDate: true })
                }
                                    ...
                                    <div className="card-body ">
                                        <form onSubmit={this.pass}>
                                            ...
                                            <div className="row" style={{padding:0}}>
                                               ...
                                               {this.state.showJoiningDate ? <div id="errordiv" className="container-fluid">Please fill out Reporting Date field * </div> : null}
                                               </div>
                                           </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div className="row" style={{padding:0}}>
                                               ...
                                               <div className="col-6 p-0" style={{width:0}}>
                                               {this.state.showCourseName ? <div id="errordiv" className="container-fluid">Please fill out Reporting Date field * </div> : null}
                                               </div>
                                           </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div className="row" style={{padding:0}}>
                                               <div className="col-6 p-0" >
                                               {this.state.showTrainingStartDate ? <div id="errordiv" className="container-fluid">Please fill out Name field * </div> : null}
                                           
                                           
                                               </div>
                                               <div className="col-6 p-0" style={{width:0}}>
                                               {this.state.showTrainingEndDate ? <div id="errordiv" className="container-fluid">Please fill out Reporting Date field * </div> : null}
                                               </div>
                                           </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div className="row" style={{padding:0}}>
                                               <div className="col-6 p-0" >
                                               {this.state.showBranchName ? <div id="errordiv" className="container-fluid">Please fill out Name field * </div> : null}
                                           
                                           
                                               </div>
                                               <div className="col-6 p-0" style={{width:0}}>
                                               {this.state.showBranchLocation? <div id="errordiv" className="container-fluid">Please fill out Reporting Date field * </div> : null}
                                               </div>
                                           </div>
                                            <div className="row">
